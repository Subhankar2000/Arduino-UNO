...
Adafruit_ILI9481_8bit_STM::Adafruit_ILI9481_8bit_STM(void)
: Adafruit_GFX(ILI9481_TFTWIDTH, ILI9481_TFTHEIGHT) {
...
void Adafruit_ILI9481_8bit_STM::setWriteDataBus(void) {
...
void Adafruit_ILI9481_8bit_STM::setReadDataBus(void) {
...
void Adafruit_ILI9481_8bit_STM::write8(uint8_t c) {
...
void Adafruit_ILI9481_8bit_STM::writecommand(uint8_t c) {
  CD_COMMAND;
...
void Adafruit_ILI9481_8bit_STM::writedata(uint8_t c) {
  CD_DATA;
...
void Adafruit_ILI9481_8bit_STM::commandList(uint8_t *addr) {
...
void Adafruit_ILI9481_8bit_STM::begin(void) {
...
void Adafruit_ILI9481_8bit_STM::setAddrWindow(uint16_t x0, uint16_t y0, uint16_t x1,
                                        uint16_t y1) {								
  CS_ACTIVE;
  CD_COMMAND;
  write8special(ILI9481_CASET); // Column addr set
  CD_DATA;
  write8special(x0 >> 8);
  ...
  write8special(ILI9481_PASET); // Row addr set
  CD_DATA;
  write8special(y0 >> 8);
  ...
  CD_COMMAND;
  write8special(ILI9481_RAMWR); // write to RAM

}


void Adafruit_ILI9481_8bit_STM::pushColor(uint16_t color) {
  writedata(color >> 8);
  writedata(color);
}

void Adafruit_ILI9481_8bit_STM::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
void Adafruit_ILI9481_8bit_STM::drawFastVLine(int16_t x, int16_t y, int16_t h,
                                        uint16_t color) {
...
void Adafruit_ILI9481_8bit_STM::drawFastHLine(int16_t x, int16_t y, int16_t w,
                                        uint16_t color) {
...
void Adafruit_ILI9481_8bit_STM::fillScreen(uint16_t color) {

  fillRect(0, 0,  _width, _height, color);
}

// fill a rectangle
void Adafruit_ILI9481_8bit_STM::fillRect(int16_t x, int16_t y, int16_t w, int16_t h,
                                   uint16_t color) {
...
void Adafruit_ILI9481_8bit_STM::drawLine(int16_t x0, int16_t y0,int16_t x1, int16_t y1, uint16_t color)
{
...
uint16_t Adafruit_ILI9481_8bit_STM::color565(uint8_t r, uint8_t g, uint8_t b) {
...
void Adafruit_ILI9481_8bit_STM::invertDisplay(boolean i) {
...
uint8_t Adafruit_ILI9481_8bit_STM::read8(void){
  RD_ACTIVE;
  delay(5);
...
uint8_t Adafruit_ILI9481_8bit_STM::readcommand8(uint8_t c) {
  writecommand(c);
  CS_ACTIVE;
  CD_DATA;
  setReadDataBus();
 ...
 uint32_t Adafruit_ILI9481_8bit_STM::readID(void) {
 writecommand(ILI9481_RDDID);
 CS_ACTIVE;
 CD_DATA;
 setReadDataBus();
 uint32_t r = read8();
